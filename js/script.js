...
function formPage(){
  ...
  formHTML.innerHTML += ('<h4 class="text-center mt-2">Where are you headed?</h4> <!-- Use autocomplete from Google API -->')
  formHTML.innerHTML += ('<input type="text" class="form-control">');
  formHTML.innerHTML += ('</div>');
  formHTML.innerHTML += ('<div class="col">');
  formHTML.innerHTML += ('<h4 class="text-center mt-2">When are you heading there?</h4> <!-- Use datepicker from JQuery UI -->');
  formHTML.innerHTML += ('<input type="text" class="form-control">');
  formHTML.innerHTML += ('</div>');
  formHTML.innerHTML += ('</div>');
  formHTML.innerHTML += ('<div class="row">');
  formHTML.innerHTML += ('<div class="col">');
  formHTML.innerHTML += ('<h4 class="text-center mt-2">How many people?</h4>');
  formHTML.innerHTML += ('<input type="text" class="form-control">');
  formHTML.innerHTML += ('</div>');
  formHTML.innerHTML += ('<div class="col">');
  formHTML.innerHTML += ('<h4 class="text-center mt-2">How many nights?</h4>');
  formHTML.innerHTML += ('<input type="text" class="form-control">');
  formHTML.innerHTML += ('</div>');
  formHTML.innerHTML += ('</div>');
  formHTML.innerHTML += ('<div class="row">');
  formHTML.innerHTML += ('<div class="col">');
  formHTML.innerHTML += ('<button type="button" class="btn btn-dark btn-lg mt-2 d-flex justify-content-center" onclick="resultsPage();">Find Accommodation</button>');
  formHTML.innerHTML += ('</div>');
  formHTML.innerHTML += ('</div>');
}
